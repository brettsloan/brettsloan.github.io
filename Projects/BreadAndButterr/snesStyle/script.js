...
img.src = '../Pics/eightbit/FF7Cursor.png';
...
e.preventDefault();
if(e.target.parentNode.parentNode.id == 'menu'){
    tokenMenu = parseInt(e.target.parentNode.getAttribute("number"));
    selection(tokenMenu);
    move.play();
}
}
...
switch(archive){
    ...
    file = {
        ...
        firstPosition: "front", firstName: "Bread", firstLevel: 9, firstStatus: "Sadness", firstHpMin: 333, firstHpMax: 333,
        firstMpMin: 63, firstMpMax: 63, firstLevelBar: 100, firstLimitBar: 180, firstLimitLevel: 1, firstActive: "yes",
...
document.querySelector("#firstLevel").innerHTML =`${file.firstLevel}<span id = "firstStatus">sadness</span>`;
...
document.querySelector("#firstLimitBar").classList.add(limitBarColor(file.firstStatus,180,"first"));
document.querySelector("#secondLimitBar").classList.add(limitBarColor(file.secondStatus,180,"second"));
document.querySelector("#thirdLimitBar").classList.add(limitBarColor(file.thirdStatus,180, "third"));
